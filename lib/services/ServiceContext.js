 ...
 */
ServiceContext.prototype.getInfo = function getInfo() {
 ...
 */
ServiceContext.prototype.getName = function getName() {
 ...
 */
ServiceContext.prototype.getApi = function getApi() {
    var info = this.getInfo();
 ...
 */
ServiceContext.prototype.getConfig = function getConfig() {
    if (checkTypes.not.object(this.context) || checkTypes.emptyObject(this.context) ||
 ...
 */
ServiceContext.prototype.getLocation = function getLocation() {
 ...
 */
ServiceContext.prototype.getDependencies = function getDependencies() {
    var config = this.getConfig();
 ...
 */
ServiceContext.prototype.getGlobalSecurity = function getGlobalSecurity() {
    if (checkTypes.not.object(this.context) || checkTypes.emptyObject(this.context) ||
 ...
 */
ServiceContext.prototype.getOperations = function getOperations() {
    if (checkTypes.not.object(this.context) || checkTypes.emptyObject(this.context) ||
 ...
 */
ServiceContext.prototype.getOperation = function getOperation(operationName) {
 ...
 */
ServiceContext.prototype.getSecurity = function getSecurity(operationName) {
