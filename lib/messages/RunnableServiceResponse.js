...
const AbstractResponse = require('./AbstractResponse').AbstractResponse;
 ...
 * @class
 */
module.exports.RunnableServiceResponse = class RunnableServiceResponse extends AbstractResponse {
    /**
