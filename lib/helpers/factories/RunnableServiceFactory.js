...
const logger = require('../logging/LoggerManager').getLogger('RunnableServiceFactory');
const checkDirectory = require('../fs/CheckDirectory');
...
const RunnableService = require('../../services/RunnableService').RunnableService;
...
module.exports.createService = function createService(serviceName, servicePath) {
    ...
    const isServicePathDirectory = checkDirectory.isDirectorySync(servicePath);
